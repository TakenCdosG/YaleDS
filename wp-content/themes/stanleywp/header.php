...
<nav role="navigation">
    <div class="navbar navbar-inverse navbar-static-top">
        <div class="container">
           ...
           <?php if( bi_get_data('custom_logo') !== '' ) { ?>
            ...
            <a class="navbar-brand nb-title" href="<?php bloginfo( 'url' ) ?>/" title="<?php bloginfo( 'name' ) ?>" rel="homepage"><b><?php bloginfo( 'name' ) ?></b></a>
            <?php } else { ?>
    ...
    <div class="container container-full navbar-reverse">
